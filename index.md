...
|현상태|전이상태|전이조건|
|:---:|:---:|:---:|
|기본상태(Idle)||아무것도 하지 않은 기본상태 입니다.|
|모든 상태 중(예외. 상호작용 중)|앞으로 이동|'W'키를 누릅니다.|
|모든 상태 중(예외. 상호작용 중)|뒤로 이동|'S'키를 누릅니다.|
|모든 상태 중(예외. 상호작용 중)|오른쪽으로 이동|'D'키를 누릅니다.|
|모든 상태 중(예외. 상호작용 중)|왼쪽으로 이동|'A'키를 누릅니다.|
